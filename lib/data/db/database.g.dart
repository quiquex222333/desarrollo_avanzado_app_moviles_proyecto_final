...
class Product extends DataClass implements Insertable<Product> {
  ...
  @override
  int get hashCode => Object.hash(id, code, name, description, category, unit,
      price, imageUrl, isActive, updatedAt);
  @override
...
class $StoresTable extends Stores with TableInfo<$StoresTable, Store> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, location, isActive, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Store extends DataClass implements Insertable<Store> {
  ...
  @override
  int get hashCode => Object.hash(id, name, location, isActive, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Store &&
...
class $StockTable extends Stock with TableInfo<$StockTable, StockData> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, productId, storeId, warehouseId, quantity, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class StockData extends DataClass implements Insertable<StockData> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, productId, storeId, warehouseId, quantity, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is StockData &&
...
class $PurchasesTable extends Purchases
  ...
  late final GeneratedColumn<String> destinationStoreId =
      GeneratedColumn<String>('destination_store_id', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _destinationWarehouseIdMeta =
      const VerificationMeta('destinationWarehouseId');
  @override
  late final GeneratedColumn<String> destinationWarehouseId =
      GeneratedColumn<String>('destination_warehouse_id', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
...
class Purchase extends DataClass implements Insertable<Purchase> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || destinationStoreId != null) {
      map['destination_store_id'] = Variable<String>(destinationStoreId);
    }
    if (!nullToAbsent || destinationWarehouseId != null) {
      map['destination_warehouse_id'] =
          Variable<String>(destinationWarehouseId);
    }
  ...
  PurchasesCompanion toCompanion(bool nullToAbsent) {
    return PurchasesCompanion(
      ...
      supplierId: supplierId == null && nullToAbsent
          ? const Value.absent()
          : Value(supplierId),
      destinationStoreId: destinationStoreId == null && nullToAbsent
          ? const Value.absent()
          : Value(destinationStoreId),
      destinationWarehouseId: destinationWarehouseId == null && nullToAbsent
          ? const Value.absent()
  ...
  factory Purchase.fromJson(Map<String, dynamic> json,
    ...
    return Purchase(
      ...
      destinationWarehouseId:
          serializer.fromJson<String?>(json['destinationWarehouseId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'destinationWarehouseId':
          serializer.toJson<String?>(destinationWarehouseId),
  ...
  Purchase copyWith(
          ...
          Value<String?> destinationWarehouseId = const Value.absent(),
          DateTime? date,
          double? total,
      ...
      Purchase(
        ...
        destinationStoreId: destinationStoreId.present
            ? destinationStoreId.value
            : this.destinationStoreId,
        destinationWarehouseId: destinationWarehouseId.present
  ...
  @override
  int get hashCode => Object.hash(id, supplierId, destinationStoreId,
      destinationWarehouseId, date, total, createdBy);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Purchase &&
...
class PurchasesCompanion extends UpdateCompanion<Purchase> {
  ...
  final Value<String?> destinationWarehouseId;
  ...
  static Insertable<Purchase> custom({
    ...
    Expression<String>? destinationWarehouseId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (destinationWarehouseId.present) {
      map['destination_warehouse_id'] =
          Variable<String>(destinationWarehouseId.value);
    }
    if (date.present) {
...
class $PurchaseItemsTable extends PurchaseItems
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, purchaseId, productId, quantity, price];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $SalesTable extends Sales with TableInfo<$SalesTable, Sale> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, customerName, storeId, date, total, createdBy];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Sale extends DataClass implements Insertable<Sale> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, customerName, storeId, date, total, createdBy);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Sale &&
...
class $$ProductsTableTableManager extends RootTableManager<
    ...
    PrefetchHooks Function(
        {bool stockRefs, bool purchaseItemsRefs, bool saleItemsRefs})> {
...
final class $$StoresTableReferences
  ...
  static MultiTypedResultKey<$StockTable, List<StockData>> _stockRefsTable(
          _$AppDatabase db) =>
      MultiTypedResultKey.fromTable(db.stock,
          aliasName: $_aliasNameGenerator(db.stores.id, db.stock.storeId));
          ...
          prefetchHooksCallback: ({stockRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (stockRefs)
                    await $_getPrefetchedData<Store, $StoresTable, StockData>(
                        currentTable: table,
                        referencedTable:
                            $$StoresTableReferences._stockRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$StoresTableReferences(db, table, p0).stockRefs,
...
final class $$WarehousesTableReferences
  ...
  static MultiTypedResultKey<$StockTable, List<StockData>> _stockRefsTable(
      ...
      MultiTypedResultKey.fromTable(db.stock,
          aliasName:
              $_aliasNameGenerator(db.warehouses.id, db.stock.warehouseId));
                ...
                return [
                  if (stockRefs)
                    await $_getPrefetchedData<Warehouse, $WarehousesTable,
                        ...
                        currentTable: table,
                        referencedTable:
                            $$WarehousesTableReferences._stockRefsTable(db),
                        managerFromTypedResult: (p0) =>
...
final class $$StockTableReferences
  ...
  static $StoresTable _storeIdTable(_$AppDatabase db) => db.stores
      .createAlias($_aliasNameGenerator(db.stock.storeId, db.stores.id));
...
class $$StockTableTableManager extends RootTableManager<
    ...
    StockData,
    PrefetchHooks Function({bool productId, bool storeId, bool warehouseId})> {
  $$StockTableTableManager(_$AppDatabase db, $StockTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: (
              {productId = false, storeId = false, warehouseId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
                ...
                if (storeId) {
                  state = state.withJoin(
                    ...
                    referencedTable: $$StockTableReferences._storeIdTable(db),
                    referencedColumn:
                        $$StockTableReferences._storeIdTable(db).id,
                  ) as T;
                }
                if (warehouseId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$StockTableReferences._warehouseIdTable(db),
                    referencedColumn:
                        $$StockTableReferences._warehouseIdTable(db).id,
                  ) as T;
                }
...
class $$PurchasesTableFilterComposer
  ...
  ColumnFilters<String> get destinationStoreId => $composableBuilder(
      column: $table.destinationStoreId,
...
class $$PurchasesTableOrderingComposer
  ...
  ColumnOrderings<String> get destinationStoreId => $composableBuilder(
      column: $table.destinationStoreId,
...
class $$PurchasesTableAnnotationComposer
  ...
  GeneratedColumn<String> get destinationStoreId => $composableBuilder(
      column: $table.destinationStoreId, builder: (column) => column);

  GeneratedColumn<String> get destinationWarehouseId => $composableBuilder(
      column: $table.destinationWarehouseId, builder: (column) => column);
